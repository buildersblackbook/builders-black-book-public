...
Clean, professional, and direct version
"""
...
with col_logo:
    ...
    if logo_path.exists():
        ...
        st.image("https://via.placeholder.com/120x40/1a365d/ffffff?text=BB", width=120)

with col_title:
    st.title("Get Considered for Projects")
    st.caption("Builder's Black Book | Nashville")
